...
const directory = settings.get().advanced.log_directory ? settings.get().advanced.log_directory.replace('%TIMESTAMP%', timestamp): false

// Make sure that log directory exsists
if (directory) {
...
// When file logging enabled append transport
if (directory) {
    logger.add(
